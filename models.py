...
class User(db.Model, UserMixin):
    ...
    batch = db.Column(db.String(10), nullable=False)  # changed from Integer to String
    course = db.Column(db.String(20), nullable=False)  # changed from Enum to String
    branch = db.Column(db.String(20), nullable=False)  # changed from Enum to String
    is_verified = db.Column(db.Boolean, default=True)  # changed default from False to True

    # Optional: keep your other fields like profile_pic, created_at, relationships
...
class Item(db.Model):
    ...
    category_id = db.Column(db.Integer, db.ForeignKey('categories.id'), nullable=False)  # Correct table name
